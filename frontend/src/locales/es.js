...
export default {
  'Start a routine': 'Empezar rutina',
  'Start set timer': 'Cronometrar serie',
  'Paused': 'Pausado',
  'Pause': 'Pausar',
  'Resume': 'Reanudar',
  'Workout paused — time not counting': 'Entrenamiento pausado — el tiempo no cuenta',
  'Time under tension': 'Tiempo bajo tensión',
  'Swap exercise': 'Cambiar ejercicio',
  'Easy mode': 'Modo fácil',
  'Edit a routine inline — series, reps, unilateral & weight per set. No advanced options.': 'Edita la rutina en línea — series, reps, unilateral y peso por serie. Sin opciones avanzadas.',
  'Unilateral (per side)': 'Unilateral (por lado)',
  'You still log the total: {0} is {1} per side.': 'Igual registras el total: {0} son {1} por lado.',
  'Weight per set': 'Peso por serie',
  'A different weight for each set instead of one for all.': 'Un peso distinto para cada serie en vez de uno para todas.',
  'Set {0}': 'Serie {0}',
  'Weigh-in before workout': 'Pesarme antes de entrenar',
  'Never': 'Nunca',
  'Weekly': 'Semanal',
  'Monthly': 'Mensual',
  'Asks at most once a week before you start.': 'Te lo pide como máximo una vez por semana antes de empezar.',
  'Asks at most once a month before you start.': 'Te lo pide como máximo una vez al mes antes de empezar.',
  'Confirm': 'Confirmar',
  'Cancel': 'Cancelar',
  'Delete': 'Eliminar',
  'Save': 'Guardar',
  ...
  // --- v1.3.0: start flow, drop sets, PR tagging, RIR, warmup, consistency ---
  'Start plan routine': 'Iniciar rutina del plan',
  'Pick another routine': 'Iniciar otra rutina',
  'Add exercises on the fly': 'Agregar ejercicios en la marcha',
  'Log a finished workout': 'Registrar entrenamiento terminado',
  'How many exercises did you do?': '¿Cuántos ejercicios hiciste?',
  'Exercise {0} of {1}': 'Ejercicio {0} de {1}',
  'Pick exercise': 'Elegir ejercicio',
  'Add set': 'Añadir serie',
  'Drop set': 'Drop set',
  'Add drop': 'Agregar drop',
  'Personal Record': 'Récord personal',
  'Start warm-up': 'Iniciar con precalentamiento',
  'Switch to workout': 'Pasar a entrenamiento',
  'Warm-up': 'Precalentamiento',
  'Start rest': 'Iniciar descanso',
  'Consistency': 'Constancia',
  '{0}% consistency': '{0}% constancia',
  '{0} of {1} sessions': '{0} de {1} sesiones',
  'Your records': 'Tus récords',
  'Track records': 'Registrar récords',
  'Pick exercises to track': 'Elige ejercicios a registrar',
  'No PR logged yet': 'Aún sin récord registrado',
  'Edit PR': 'Editar récord',
  'Log retroactive workout': 'Registrar entrenamiento retroactivo',
  'Done — save workout': 'Listo — guardar entrenamiento',
